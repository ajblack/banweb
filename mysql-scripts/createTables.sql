...
create table prereqs (
  ...
  pdept		varchar(5),
  pcourse_num	int(5),
  foreign key (dept) references classes(dept),
  foreign key (course_num) references classes(course_num),
  foreign key (pdept) references classes(dept),
  foreign key (pcourse_num) references classes(course_num),
  primary key (dept, course_num, pdept, pcourse_num));
