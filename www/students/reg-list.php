...
<?php
  ...
  echo '<td class="table-col-title">Day</td>';
  echo '<td class="table-col-title">Time</td>';
  echo '<td class="table-col-title">Register?</td>';
  echo '</tr>';
  echo '<form method="post" action="list-confirm.php">';
  ...
  echo '<input type="hidden" value="'.$semester.'" name="semid" />';
