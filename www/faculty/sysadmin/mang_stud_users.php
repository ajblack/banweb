...
<?php
  ...
  echo '<table>';
  echo '<tr>';
  echo '<td><form method="post" action="mang_stud_users.php">';  
  echo '<input type="submit" value="Show All Student Users" name="submit">';
  echo '<input type="hidden" value="' . $id . '" name="id" />';
  echo '<input type="hidden" value="true" name="showall" />';
  echo '</form></td>';
  echo '<td><form method="post" action="add_stud_user.php">';  
  echo '<input type="submit" value="Add Student User" name="submit">';
  echo '<input type="hidden" value="' . $id . '" name="id" />';
  echo '</form></td>';
  echo '</tr>';
  echo '</table>';
  ...
  echo '<form method="post" action="mang_stud_users.php">';
  ...
  if( $sid != NULL || $fname != NULL || $lname != NULL || $showall != NULL) {
    ...
    if ( mysql_num_rows($result)==0 ) {
      echo '<br />Error: Student Does Not Exist<br />';
    } else {
  ...
  echo '</tr>';
  echo '<form method="post" action="remove-stud-confirm.php">';
